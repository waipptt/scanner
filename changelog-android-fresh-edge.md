...
Changes:
- Fixed the way preloads are handled in Android to make preloaded views act more like they do on iOS e.g. regarding the nav bar. Fixes [#646](https://github.com/AppGyver/steroids/issues/646).
